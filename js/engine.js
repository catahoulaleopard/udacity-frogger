...
var Engine = (function (global) {
    ...
    * of the functions which needed to update entity's data.
    */
   function update(dt) {
      updateEntities(dt);
    ...
    * the renderEntities function. Called every game tick (or loop of the game engine),
    ...
    * tick. Its purpose is to then call the enemy and player render methods within app.js
    */
